<template>
    <div id="pictureManagerPage">
        <a-form layout="inline" :model="searchParams" @finish="doSearch">
            ...
            <a-form-item>
                <a-select v-model:value="searchParams.tags" mode="tags" allow-clear placeholder="请输入标签" style="min-width: 180px;"></a-select>
            </a-form-item>
            <a-form-item>
...
import { deletePictureUsingPost, listPictureByPageUsingPost, listPictureVoByPageUsingPost } from '@/api/pictureController';
